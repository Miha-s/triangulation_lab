...
void PolygonBuilderController::set_polygon_addition_layer(ShapeAdditionLayerPtr polygon_addition_l)
{
    m_polygon_addition_l = polygon_addition_l;
}

void PolygonBuilderController::add_point(sf::Vector2f point)
{
